    ...
    public void init() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                syncQueue = new SyncQueueImpl(blockchain);//缓存

                //区块头下载线程：每当前文中所述的 maxNum - minNum < 20000 时，便向已连接的空闲网络节点发送下载区块头请求。
                ...
                //每当前文中所述的 SyncManager 维持的区块队列的大小小于 2000 时，便向已连接的空闲网络节点发送下载区块体请求。
