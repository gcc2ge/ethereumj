...
public class EncryptionHandshake {
    ...
    /**\
     * From the point of view of one peer we will distinguish connections in two ways.
     * If the connection was initiated by a peer, we say that they are the initiator,
     * and the other peer is receiver.
     * The word remote is used to describe the 'other' peer in a connection
     * when talking from a point of view of a node.
     */
